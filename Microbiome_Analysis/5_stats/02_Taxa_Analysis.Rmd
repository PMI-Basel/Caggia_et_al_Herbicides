...
bPHYSEQ_phyla_melt <- bPHYSEQ_phyla_melt[order(bPHYSEQ_phyla_melt$Timepoint),]
...
bPHYSEQ_phyla_melt$Timepoint <- as.factor(bPHYSEQ_phyla_melt$Timepoint)
levels(bPHYSEQ_phyla_melt$Timepoint) <- c("2W", "5W")
...
fig2.1 <- ggplot(bPHYSEQ_phyla_melt, aes_string(x="SampleID2", y="Abundance", fill="labels_2")) + 
  ...
  facet_grid(Timepoint ~ Experiment, scale="free_x", space="free_x") +
  geom_text(data=bPHYSEQ_phyla_melt, aes(label=paste0(Herbicide, " ", Spraying), y=-15), angle=90, check_overlap=T, size=3, hjust = 0.25) + 
  theme_bw()+
...
fPHYSEQ_phyla_melt <- fPHYSEQ_phyla_melt[order(fPHYSEQ_phyla_melt$Timepoint),]
...
fPHYSEQ_phyla_melt$Timepoint <- as.factor(fPHYSEQ_phyla_melt$Timepoint)
levels(fPHYSEQ_phyla_melt$Timepoint) <- c("2W", "5W")
...
fig2.2 <- ggplot(fPHYSEQ_phyla_melt, aes_string(x="SampleID2", y="Abundance", fill="labels_2")) + 
  ...
  guides(fill=guide_legend(title="Phylum"))+
  facet_grid(Timepoint ~ Experiment, scale="free_x", space="free_x") +
  geom_text(data=fPHYSEQ_phyla_melt, aes(label=paste0(Herbicide, " ", Spraying), y=-15), angle=90, check_overlap=T, size=3, hjust = 0.25) + 
  theme_bw()+
